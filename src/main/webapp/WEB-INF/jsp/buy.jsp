...
<div class="container">
    <div class="main">
        ...
        <div class="shoping_bag1">
            <div class="shoping_left">
                ...
                <div class="shoping1_of_2">
                    ...
                    <ul class="s_icons">
                        <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/s_icon1.png"
                                             alt=""></a></li>
                        <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/s_icon2.png"
                                             alt=""></a></li>
                        <li><a href="#"><img src="${pageContext.request.contextPath}/resources/images/s_icon3.png"
                                             alt=""></a></li>
                    </ul>
                </div>
                <div class="clearfix"></div>
        ...
        <div class="shoping_bag1">
            <div class="shoping_left">
                <h2><a href="#"><img src="${pageContext.request.contextPath}/resources/images/gift.jpg">礼品包装 </a> <span> for rs. 25</span>
                </h2>
            </div>
            <div class="shoping_right">
        ...
        <div class="shoping_bag1">
            <div class="shoping_left">
                <h2><a href="#"><img src="${pageContext.request.contextPath}/resources/images/login.jpg">login </a>
                    <span> to apply coupons</span></h2>
            </div>
            <div class="shoping_right">
